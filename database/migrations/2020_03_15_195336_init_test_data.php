...
class InitTestData extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('product')->insertOrIgnore([
            ['id' => 1, 'name' => 'Test Bouquet', 'desc' => 'Test bouquet', 'product_type_id' => 1, 'with_alcohol' => 1, 'img' => '', 'created_at' => 1584302277, 'updated_at' => 1584302277],
            ['id' => 2, 'name' => 'Test Box', 'desc' => 'Test box', 'product_type_id' => 2, 'with_alcohol' => 1, 'img' => '', 'created_at' => 1584302277, 'updated_at' => 1584302277],
            ['id' => 3, 'name' => 'Test Bouquet 2', 'desc' => 'Test bouquet', 'product_type_id' => 1, 'with_alcohol' => 1, 'img' => '', 'created_at' => 1584302277, 'updated_at' => 1584302277],
        ]);
